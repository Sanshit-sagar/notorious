...
def open_file(): 
    # Get Filename 
    text_file = filedialog.askopenfilename(initialdir="/Users/sanshitsagar/Desktop", title="Open File", filetypes=(("Text Files", "*.txt"), ("HTML Files", "*.html"), ("Python Files", "*.py"), ("All Files", "*.*")))
...
def save_as_file(): 
    ...
    text_file = filedialog.asksaveasfilename(defaultextension=".*", initialdir=prefix, title="Save File", filetypes=(
        ("Text Files", "*.txt"), 
        ("HTML Files", "*.html"), 
        ("Python Files", "*.py"), 
        ("All Files", "*.*")
...
#Create Text Box 
my_text = Text(my_frame, width=100, height=25, font=('Helvetica', 16), selectbackground="yellow",  selectforeground="black", undo=True, yscrollcommand=text_scroll.set, wrap="none", xscrollcommand=hor_scroll.set)
my_text.pack() 
